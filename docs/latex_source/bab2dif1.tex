...
Di mana \((x, y)\) adalah koordinat asli piksel, \((x', y')\) adalah koordinat piksel setelah rotasi, dan \(\theta\) adalah sudut rotasi dalam radian. Proses ini memastikan bahwa citra dapat diputar sesuai kebutuhan tanpa kehilangan informasi penting yang terkandung di dalamnya (\cite[hlm. 45--47]{Gonzalez2018}).
