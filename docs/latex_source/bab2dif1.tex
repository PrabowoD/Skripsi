...
\begin{figure}[H]
  \centering
  \includegraphics[keepaspectratio, width=10cm]{gambar/Colour_pixel.jpg}
...
\caption{Berikut adalah hasil dari citra Grayscale}\label{fig:grayscale}
\end{figure}
...
Sifat ini sangat berguna dalam praktik karena penghalusan sinyal dua dimensi dapat digantikan oleh dua penghalusan satu dimensi, satu untuk setiap dimensi (\cite{Lowe2004}). 
