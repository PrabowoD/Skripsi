...
\begin{tabular}{ll}
  ...
  Judul & : Penambahan Fungsi Indexing Pada Search Engine \\ & \hspace{0.2cm}
  Telusuri Melalui Inverted Index Untuk Meningkatkan \\ & \hspace{0.2cm}
  Performa Waktu Pencarian
\end{tabular}
