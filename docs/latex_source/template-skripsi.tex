...
%-----------------------------------------------------------------
\titleind{Pengukuran Panjang dan Estimasi Berat Ikan Menggunakan Metode Harris Corner Detection Berbasis Citra Digital}
...
%\include{pengesahan}
% \includepdf[pages=-]{sps/Lembar Pengesahan.pdf}
