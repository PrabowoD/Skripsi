...
% \subsection{Penghapusan Background}
	...
	\begin{subfigure}{.3\textwidth}
		\centering
        \includegraphics[keepaspectratio, width=3cm]{C:/Users/USER/Documents/GitHub/Skripsi/Output/Rembg/IMG_20240121_131125.jpg}
		\caption{Ikan Mas}
	\end{subfigure}
	\begin{subfigure}{.3\textwidth}
		\centering
		\includegraphics[keepaspectratio, width=3cm]{C:/Users/USER/Documents/GitHub/Skripsi/Output/Rembg/IMG_20240121_132544.jpg}
		\caption{Ikan lele}
	\end{subfigure} 
	\begin{subfigure}{.3\textwidth}
		\centering
		\includegraphics[keepaspectratio, width=3cm]{C:/Users/USER/Documents/GitHub/Skripsi/Output/Rembg/IMG_20240121_140044.jpg}
		\caption{Ikan Nila Merah}
	\end{subfigure}
...
\subsection{Rotasi}
    ...
    \begin{figure}[H]
        ...
        \begin{subfigure}{.3\textwidth}
            \centering
            \includegraphics[keepaspectratio, width=4cm]{C:/Users/USER/Documents/GitHub/Skripsi/Output/IMG_20240121_131125.jpg}
            \caption{Sebelum Rotasi}
        \end{subfigure}
        \begin{subfigure}{.3\textwidth}
            \centering
            \includegraphics[keepaspectratio, width=4cm]{C:/Users/USER/Documents/GitHub/Skripsi/Output/Rotated/IMG_20240121_131125.jpg}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{.3\textwidth}
        \centering
        \includegraphics[keepaspectratio, width=4.2cm]{C:/Users/USER/Documents/GitHub/Skripsi/Output/Box/IMG_20240121_131125.jpg}
        \caption{Ikan Mas}
    \end{subfigure}
    \begin{subfigure}{.3\textwidth}
        \centering
        \includegraphics[keepaspectratio, width=4.2cm]{C:/Users/USER/Documents/GitHub/Skripsi/Output/Box/IMG_20240121_132544.jpg}
        \caption{Ikan lele}
    \end{subfigure} 
    \begin{subfigure}{.3\textwidth}
        \centering
        \includegraphics[keepaspectratio, width=4.2cm]{C:/Users/USER/Documents/GitHub/Skripsi/Output/Box/IMG_20240121_140044.jpg}
        \caption{Ikan Nila}
    \end{subfigure}
...
\end{equation}
    Dimana \(d\) adalah jarak antar titik pada gambar.
...
\begin{equation*}
    Keliling\ Ikan = 2 \times (Panjang\ Ikan + Lebar\ Ikan)
\end{equation*}
\begin{equation*}
    Berat\ Ikan = Keliling\ Ikan \times Berat\ Rata\ per\ Keliling\ Ikan
\end{equation*}

% dapat dilakukan menggunakan rumus interpolasi linier berdasarkan data panjang dan berat ikan yang telah diketahui sebelumnya. Rumus interpolasi linier yang digunakan adalah:
% % \begin{equation}
