...
namun kriteria tersebut dapat berubah jika jenis ikan yang digunakan seperti ikan lele maka :
\begin{enumerate}
    \item Sudut berada pada bagian ekor.
    \item Sudut berada pada bagian mulut.
    \item Sudut berada pada bagian sirip kanan.
    \item Sudut berada pada bagian sirip kiri.
\end{enumerate}
